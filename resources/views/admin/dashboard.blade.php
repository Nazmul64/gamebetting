            ...
            <nav class="sidebar-nav">
                ...
                <div style="background: rgba(14, 22, 45, 0.6); border: 1px solid var(--border-subtle); border-radius: var(--radius-md); padding: 10px; margin-bottom: 6px;">
                    ...
                    <div id="games-module-submenu" style="display:flex; flex-direction:column; gap:4px;">
                        ...
                        <!-- Active Game 7: BonBon Bonanza -->
                        <a href="{{ route('admin.bonbon.index') }}" class="sidebar-nav-link" style="padding: 8px 10px; font-size: 12.5px; border-radius: 8px; background: rgba(232, 121, 249, 0.08); border: 1px solid rgba(232, 121, 249, 0.25); text-decoration:none; color:inherit;">
                            <i class="fas fa-candy-cane" style="color:#e879f9; font-size:13px;"></i>
                        ...
                        <!-- Active Game 9: The Emirate -->
                        <a href="{{ route('admin.emirate.index') }}" class="sidebar-nav-link" style="padding: 8px 10px; font-size: 12.5px; border-radius: 8px; background: rgba(245, 158, 11, 0.08); border: 1px solid rgba(245, 158, 11, 0.25); text-decoration:none; color:inherit;">
                            <i class="fas fa-gem" style="color:#f59e0b; font-size:13px;"></i>
